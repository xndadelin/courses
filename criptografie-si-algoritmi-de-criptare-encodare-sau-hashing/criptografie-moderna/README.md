...
{% hint style="info" %}
Criptografia modernă se deosebește semnificativ de criptografia clasică, bazându-se pe principii matematice, informatică și inginerie.
{% endhint %}
...
* Toate procesele sunt automatizate, nu este necesară interacțiunea manuală, deoarece fiecare metodă de criptare este realizată de un calculator.

## Criptare simetrica <a href="#exemplu-criptare-folosind-cheie-simetrica" id="exemplu-criptare-folosind-cheie-simetrica"></a>
